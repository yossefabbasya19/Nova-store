...
class ProductDetailsDM {
  ...
  ProductDetailsDM.fromJson(dynamic json) {
    ...
    category = json['category'] != null ? CategoryDetailsDm.fromJson(json['category']) : null;
    brand = json['brand'] != null ? BrandsDetailsDm.fromJson(json['brand']) : null;
